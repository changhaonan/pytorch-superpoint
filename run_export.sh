...
python3 evaluation.py /home/robot-learning/Projects/PointFeatureHub/external/pytorch-superpoint/logs/$export_folder/predictions --repeatibility --homography --outputImg --plotMatching
